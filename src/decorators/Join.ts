 ...
 * @param {types.IJoinFunc<WhereExprBuilder<T>, U>} joinFunc - Function defining the join condition
 * @returns {(target: Object, propertyKey: string | symbol) => void}
 */
function Join<T extends object, U extends object>(EntityType: IEntityType<U>, joinFunc: types.IJoinFunc<WhereExprBuilder<T>, U>): (target: object, propertyKey: string | symbol) => void {
