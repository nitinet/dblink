...
abstract class IQuerySet<T extends Object> {
   ...
   * @returns {IQuerySet<U>}
   */
  abstract select<U extends Object>(TargetType: exprBuilder.types.IEntityType<U>): IQuerySet<U>;
   ...
   * @returns {IQuerySet<T>}
   */
  abstract where(func: exprBuilder.types.IWhereFunc<exprBuilder.WhereExprBuilder<T>>, ...args: any[]): IQuerySet<T>;
